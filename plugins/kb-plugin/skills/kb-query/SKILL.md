...
case "$FIRST_ARG" in
    "info"|"list-topics"|"list-facts"|"facts-by-any-topics"|"facts-by-all-topics")
        ...
        echo "[STDERR] → Executing: claude-kb $ARGUMENTS" >&2
        echo "[STDOUT] → Executing: claude-kb $ARGUMENTS"
        $KB_CLI $ARGUMENTS
        ;;
    ...
    "")
        ...
        echo "[STDERR] → Executing: claude-kb info" >&2
        echo "[STDOUT] → Executing: claude-kb info"
        $KB_CLI info
        ;;
    *)
        ...
        echo "[STDERR] → Executing: claude-kb facts-by-any-topics \"$TOPICS\"" >&2
        echo "[STDOUT] → Executing: claude-kb facts-by-any-topics \"$TOPICS\""
